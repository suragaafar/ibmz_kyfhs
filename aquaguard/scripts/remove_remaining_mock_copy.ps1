...
$c = $c.Replace('AquaGuard AI uses leaderboard points as a playful mock incentive system for reporting issues and helping keep the water network visible.', 'AquaGuard AI uses leaderboard points as a community incentive system for reporting issues and helping keep the water network visible.')
